...
WebUI.verifyCheckpoint(findCheckpoint('Checkpoints/VerifyCURAData'), false)
...
WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/Page_CURA Healthcare Service/input_None_programs'))

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/Page_CURA Healthcare Service/input_Medicare_programs'))
...
WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/Page_CURA Healthcare Service/td_10'))
...
WebUI.rightClick(findTestObject('Object Repository/Page_CURA Healthcare Service/Page_CURA Healthcare Service/h2_Appointment Confirmation'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_CURA Healthcare Service/Page_CURA Healthcare Service/h2_Appointment Confirmation'), 
    0)
