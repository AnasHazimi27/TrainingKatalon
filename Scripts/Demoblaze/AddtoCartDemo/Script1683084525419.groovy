...
WebUI.callTestCase(findTestCase('Demoblaze/LoginDemoblaze'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.navigateToUrl('https://www.demoblaze.com/')

WebUI.click(findTestObject('Object Repository/Page_STORE/a_Samsung galaxy s6'))

WebUI.click(findTestObject('Object Repository/Page_STORE/h2_Samsung galaxy s6'))
